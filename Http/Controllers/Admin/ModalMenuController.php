...
class ModalMenuController extends AjaxResource
{
    public function __construct()
    {
        ...
        $this->actions['view_main'] = "menus::admin.modal.menu_code.main";
        $this->actions['view_filter'] = "menus::admin.modal.menu_code.filter";
        $this->actions['view_list'] = "menus::admin.modal.menu_code.list";
        $this->actions['view_form'] = "menus::admin.modal.menu_code.form";
